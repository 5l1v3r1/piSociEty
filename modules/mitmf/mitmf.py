...
mitmf_version = '1.0'
mitmf_codename = 'The Anarchist'
mitmf_author = 'Written by byt3bl33d3r, customized by Paran0!d N!nja!'

if os.geteuid() != 0:
    sys.exit("[-] The derp level is way too high brah")

parser = argparse.ArgumentParser(description="MITMf v{} - '{}' - {}".format(mitmf_version, mitmf_codename, mitmf_author), 
                                 version="{} - '{}' - {}".format(mitmf_version, mitmf_codename, mitmf_author), 
                                 usage='mitmf.py -i interface [mitmf options] [plugin name] [plugin options]', 
                                 epilog="If you can't understand it, you don't deserve it...",
